...
win.title("Editing a Video")
win.iconbitmap("sourse/veicon.ico")
...
plugpath = pathname[:-5]
plugpath = plugpath + "/plugins for video edit"
pathname = pathname[:-5]
...
viem_colors = {
    "dark": {"selectbg":"Black"},
    "light": {"selectbg":"White"}
}

def changetheme(theme):
    win["bg"] = viem_colors[theme]["selectbg"]
